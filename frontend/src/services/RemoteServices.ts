...
export default class RemoteServices {
  ...
  static async getDifficultQuestions(dashboardId: number): Promise<DifficultQuestion[]> {
    return httpClient
        .get(
            `/students/dashboard/difficultquestion/${dashboardId}`
        )
        .then((response) => {
          return response.data.map((difficultQuestions: any) => {
            return new DifficultQuestion(difficultQuestions);
          });
        })
        .catch(async (error) => {
          throw Error(await this.errorMessage(error));
  ...
  static async updateDifficultQuestions(dashboardId: number) {
    return httpClient
        .put(`/students/dashboard/difficultquestion/update/${dashboardId}`)
        .catch(async (error) => {
          throw Error(await this.errorMessage(error));
        });
  }
  ...
  static async deleteDifficultQuestion(difficultQuestionId: number) {
    return httpClient
        .delete(`/students/dashboard/difficultquestion/remove/${difficultQuestionId}`)
        .catch(async (error) => {
          throw Error(await this.errorMessage(error));
        });
  }
  ...
  static async getWeeklyScore(dashboardId: number): Promise<WeeklyScores[]> {
    return httpClient
      .get(
        `/students/dashboard/weeklyscore/get/${dashboardId}`
      )
      .then((response) => {
        return response.data.map((weeklyScores: any) => {
          return new WeeklyScores(weeklyScores);
        });
      })
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
  ...
  static async updateWeeklyScore(dashboardId: number) {
    return httpClient
      .put(`/students/dashboard/weeklyscore/update/${dashboardId}`)
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  }
  ...
  static async deleteWeeklyScore(weeklyscoreId: number) {
    return httpClient
      .delete(`/students/weeklyScore/detele/${weeklyscoreId}`)
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  }
  ...
  static async getFailedAnswer(dashboardId: number):Promise<FailedAnswers[]> {
    return httpClient
      .get(`/students/failedAnswers/dashboards/${dashboardId}`)
      .then((response) => {
        return response.data.map((failedAnswers: any) => {
          return new FailedAnswers(failedAnswers);
        });
      })
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
  ...
  static async updateFailedAnswer(dashboardId: number) {
    return httpClient
      .put(`/students/dashboards/updates/${dashboardId}`)
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  }
  ...
  static async deleteFailedAnswer(failedAnswerId: number) {
    return httpClient
      .delete(`/students/dashboards/failedAnswers/${failedAnswerId}`)
      .catch(async (error) => {
        throw Error(await this.errorMessage(error));
      });
  }
