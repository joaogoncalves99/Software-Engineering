...
public enum ErrorMessage {
    ...
    CANNOT_CLOSE_CURRENT_WEEK("Impossible to close the current Weekly Score"),
    ...
    SAME_QUESTION_FAILED_ANSWER_ALREADY_ON_LIST("Same question failed answer already created"),
    SAME_QUESTION_FAILED_ANSWER_CANNOT_BE_REMOVED("Same question failed answer cannot be removed"),
    SAME_QUESTION_FAILED_ANSWER_NOT_ON_LIST("Same quesiton failed answer is not on the list");    
