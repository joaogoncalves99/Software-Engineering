...
Cypress.Commands.add('solveQuizzDifficultQuestion', (quizTitle, numberOfQuizQuestions) => {
...
Cypress.Commands.add('solveQuizzFailedAnswer', (quizTitle, numberOfQuizQuestions) => {
  cy.get('[data-cy="quizzesStudentMenuButton"]').click();
  cy.contains('Available').click();
