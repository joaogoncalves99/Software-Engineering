...
class CreateDifficultQuestionTest extends SpockTest {
    ...
    def "create two difficult questions with same percentage"() {
        given:
        ...
        when:
        difficultQuestionService.createDifficultQuestion(dashboard.getId(), question1.getId(), 13)
        difficultQuestionService.createDifficultQuestion(dashboard.getId(), question.getId(), 13)
    ...
    def "create two difficult questions with different percentages (< 25)"() {
        given:
        def question1 = new Question()
        question1.setTitle(QUESTION_1_TITLE)
        question1.setContent(QUESTION_1_CONTENT)
        ...
        questionDetailsRepository.save(questionDetails1)
        questionRepository.save(question1)
        difficultQuestionService.createDifficultQuestion(dashboard.getId(), question1.getId(), 10)
        when:
        difficultQuestionService.createDifficultQuestion(dashboard.getId(), question.getId(), 13)
        then:
        difficultQuestionRepository.count() == 2L
    }
    def "create three difficult questions with the same percentage"(){
        given:
        def question1 = new Question()
        question1.setTitle(QUESTION_1_TITLE)
        question1.setContent(QUESTION_1_CONTENT)
        ...
        when:
        difficultQuestionService.createDifficultQuestion(dashboard.getId(), question.getId(), 10)
        then:
        difficultQuestionRepository.count() == 3L
    }
    @TestConfiguration
